...
export function createMakharij({ar,lang,fiches,chapters,icon,num,footer,path,verse}) {
  const t = ar ? {
  ...
  const link=f=>path({type:'fiche',fiche:f.id});
